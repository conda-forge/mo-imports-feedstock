...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mo-imports-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mo-imports-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install mo-imports
```
...
It is possible to list all of the versions of `mo-imports` available on your platform:
...
```
pixi search mo-imports --channel conda-forge
```
