...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mo-imports-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11052&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mo-imports-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mo-imports` can be installed with:

```
conda install mo-imports
```

It is possible to list all of the versions of `mo-imports` available on your platform with:
